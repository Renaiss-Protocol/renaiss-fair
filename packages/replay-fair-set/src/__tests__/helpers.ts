...
import { deriveTaskSeed } from "../index";
...
/** The public key derived from SK, as hex — what an operator would publish. */
export const PK_HEX = bytesToHex(pointToString(secretScalarAndPublicKey(SK).Y));
